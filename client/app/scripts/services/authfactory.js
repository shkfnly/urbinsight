...
//   .factory('AuthFactory', ['$window', function ($window) {
//     var isLogged = false;
...
//   .factory('UserAuthFactory', ['$window', '$location', '$http', 'AuthFactory', function($window, $location, $http, AuthFactory) {
//     return {
...
//     };
//   }])
//   .factory('TokenIntercept', ['$q', '$window', function($q, $window) {
//     return {

...
angular.module('urbinsight')
  .controller('umisResourceCtrl', ['$scope', '$stateParams', 'ParcelFactory', function ($scope, $stateParams, ParcelFactory) {
      ...
      parcels.forEach(function(parcel){
        workbooks.forEach(function(resource){
          _.forEach(parcel.totalDemand[resource], function(value, junction){
            result[resource][junction] ? (result[resource][junction] += value) : (result[resouce][junction] = value);

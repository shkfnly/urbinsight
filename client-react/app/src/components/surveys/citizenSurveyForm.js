    ...
    return(
      <div>
        {/*<form className="form-inline" id="surveyForm" >
          ...
          <label>5. How do you describes your level of access to opportunities to develop healthy social relations?</label>
          <br/>
          ...
          <label>11. How would you describe the level of respect and non-discrimination you experience in your daily life?</label>
          <br/>
          ...
          <label>16. How do you describe your ability to participate in your community's decision-making processes?</label>
          <br/>
      ...
      <form id="surveyForm">
          <Input type="select" label="1. How would you describe your level of access to adequate employment?" placeholder="">
          ...
          <Input type="select" label="2. How would you describe your level of access to healthcare and health services?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="3. How would you describe your ability to provide care for family members as needed?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="5. How do you describes your level of access to opportunities to develop healthy social relations?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="6. How do you descrive your level of access to recreational opportunities and activities?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="7. How would you describe your level of access to knowledge for futhering your education?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="8. How would you describe your level of vacation(time-off) time you have?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="10. How do you describe your living environment? (this includes access to natural resources)" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="11. How would you describe the level of respect and non-discrimination you experience in your daily life?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="12. How would you describe your level of freedom to practice your religion?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="14. How do you describe your level of freedom of movement?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="15. How do you describe your level of safety and the absence of physical violence or criminality in your daily life?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
          ...
          <Input type="select" label="16. How do you describe your ability to participate in your community's political, governance-based and decision-making processes?" placeholder="">
            <option value="">Enter your response</option>
            <option value="excellent">Excellent</option>
            <option value="good">Good</option>
            <option value="adequate">Adequate</option>
